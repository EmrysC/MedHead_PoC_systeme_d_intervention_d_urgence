...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleTypeMismatch(MethodArgumentTypeMismatchException ex, WebRequest request) {
        ...
        String typeLabel = (requiredTypeClass != null) ? requiredTypeClass.getSimpleName() : "unknown type";

        Object value = ex.getValue();
        String valueString = (value != null) ? value.toString() : "null";

        String message = String.format("Parameter '%s' with value '%s' should be of type '%s'",
                name, valueString, typeLabel);
